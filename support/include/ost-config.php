...
define('SECRET_SALT','8e33b7c5d10e4bcefcccd164d84820dd');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','admin@senseware.tech');
...
define('DBNAME','sensew59_osticket');
define('DBUSER','sensew59_osticket');
define('DBPASS','(71S70N)2p');
