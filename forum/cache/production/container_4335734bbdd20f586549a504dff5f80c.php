...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'forumconfig');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumconfig_text');
    }
    ...
    {
        return $this->services['console.command.user.delete_id'] = new \phpbb\console\command\user\delete_id(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, 'forumbots', 'forumuser_group', 'forumusers', './', 'php');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php', 'forumforums', 'forumposts', 'forumtopics', 'forumusers');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('forumcaptcha_questions', 'forumcaptcha_answers', 'forumqa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'forumext', './', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'forumnotification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'forumuser_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumprofile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumbbcodes', 'forumsmilies', 'forumstyles', 'forumwords', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumforums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumforums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumgroups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumprivmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumpoll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumtopics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumposts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forumusers');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'forumusers');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'forumacl_groups',
            'tables.acl_options' => 'forumacl_options',
            'tables.acl_roles' => 'forumacl_roles',
            'tables.acl_roles_data' => 'forumacl_roles_data',
            'tables.acl_users' => 'forumacl_users',
            'tables.attachments' => 'forumattachments',
            'tables.auth_provider_oauth_token_storage' => 'forumoauth_tokens',
            'tables.auth_provider_oauth_states' => 'forumoauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'forumoauth_accounts',
            'tables.banlist' => 'forumbanlist',
            'tables.bbcodes' => 'forumbbcodes',
            'tables.bookmarks' => 'forumbookmarks',
            'tables.bots' => 'forumbots',
            'tables.captcha_qa_questions' => 'forumcaptcha_questions',
            'tables.captcha_qa_answers' => 'forumcaptcha_answers',
            'tables.captcha_qa_confirm' => 'forumqa_confirm',
            'tables.config' => 'forumconfig',
            'tables.config_text' => 'forumconfig_text',
            'tables.confirm' => 'forumconfirm',
            'tables.disallow' => 'forumdisallow',
            'tables.drafts' => 'forumdrafts',
            'tables.ext' => 'forumext',
            'tables.extensions' => 'forumextensions',
            'tables.extension_groups' => 'forumextension_groups',
            'tables.forums' => 'forumforums',
            'tables.forums_access' => 'forumforums_access',
            'tables.forums_track' => 'forumforums_track',
            'tables.forums_watch' => 'forumforums_watch',
            'tables.groups' => 'forumgroups',
            'tables.icons' => 'forumicons',
            'tables.lang' => 'forumlang',
            'tables.log' => 'forumlog',
            'tables.login_attempts' => 'forumlogin_attempts',
            'tables.migrations' => 'forummigrations',
            'tables.moderator_cache' => 'forummoderator_cache',
            'tables.modules' => 'forummodules',
            'tables.notification_emails' => 'forumnotification_emails',
            'tables.notification_types' => 'forumnotification_types',
            'tables.notifications' => 'forumnotifications',
            'tables.poll_options' => 'forumpoll_options',
            'tables.poll_votes' => 'forumpoll_votes',
            'tables.posts' => 'forumposts',
            'tables.privmsgs' => 'forumprivmsgs',
            'tables.privmsgs_folder' => 'forumprivmsgs_folder',
            'tables.privmsgs_rules' => 'forumprivmsgs_rules',
            'tables.privmsgs_to' => 'forumprivmsgs_to',
            'tables.profile_fields' => 'forumprofile_fields',
            'tables.profile_fields_data' => 'forumprofile_fields_data',
            'tables.profile_fields_options_language' => 'forumprofile_fields_lang',
            'tables.profile_fields_language' => 'forumprofile_lang',
            'tables.ranks' => 'forumranks',
            'tables.reports' => 'forumreports',
            'tables.reports_reasons' => 'forumreports_reasons',
            'tables.search_results' => 'forumsearch_results',
            'tables.search_wordlist' => 'forumsearch_wordlist',
            'tables.search_wordmatch' => 'forumsearch_wordmatch',
            'tables.sessions' => 'forumsessions',
            'tables.sessions_keys' => 'forumsessions_keys',
            'tables.sitelist' => 'forumsitelist',
            'tables.smilies' => 'forumsmilies',
            'tables.sphinx' => 'forumsphinx',
            'tables.styles' => 'forumstyles',
            'tables.styles_template' => 'forumstyles_template',
            'tables.styles_template_data' => 'forumstyles_template_data',
            'tables.styles_theme' => 'forumstyles_theme',
            'tables.styles_imageset' => 'forumstyles_imageset',
            'tables.styles_imageset_data' => 'forumstyles_imageset_data',
            'tables.teampage' => 'forumteampage',
            'tables.topics' => 'forumtopics',
            'tables.topics_posted' => 'forumtopics_posted',
            'tables.topics_track' => 'forumtopics_track',
            'tables.topics_watch' => 'forumtopics_watch',
            'tables.user_group' => 'forumuser_group',
            'tables.user_notifications' => 'forumuser_notifications',
            'tables.users' => 'forumusers',
            'tables.warnings' => 'forumwarnings',
            'tables.words' => 'forumwords',
            'tables.zebra' => 'forumzebra',
            ...
            'tables' => [
                'acl_groups' => 'forumacl_groups',
                'acl_options' => 'forumacl_options',
                'acl_roles' => 'forumacl_roles',
                'acl_roles_data' => 'forumacl_roles_data',
                'acl_users' => 'forumacl_users',
                'attachments' => 'forumattachments',
                'auth_provider_oauth_token_storage' => 'forumoauth_tokens',
                'auth_provider_oauth_states' => 'forumoauth_states',
                'auth_provider_oauth_account_assoc' => 'forumoauth_accounts',
                'banlist' => 'forumbanlist',
                'bbcodes' => 'forumbbcodes',
                'bookmarks' => 'forumbookmarks',
                'bots' => 'forumbots',
                'captcha_qa_questions' => 'forumcaptcha_questions',
                'captcha_qa_answers' => 'forumcaptcha_answers',
                'captcha_qa_confirm' => 'forumqa_confirm',
                'config' => 'forumconfig',
                'config_text' => 'forumconfig_text',
                'confirm' => 'forumconfirm',
                'disallow' => 'forumdisallow',
                'drafts' => 'forumdrafts',
                'ext' => 'forumext',
                'extensions' => 'forumextensions',
                'extension_groups' => 'forumextension_groups',
                'forums' => 'forumforums',
                'forums_access' => 'forumforums_access',
                'forums_track' => 'forumforums_track',
                'forums_watch' => 'forumforums_watch',
                'groups' => 'forumgroups',
                'icons' => 'forumicons',
                'lang' => 'forumlang',
                'log' => 'forumlog',
                'login_attempts' => 'forumlogin_attempts',
                'migrations' => 'forummigrations',
                'moderator_cache' => 'forummoderator_cache',
                'modules' => 'forummodules',
                'notification_emails' => 'forumnotification_emails',
                'notification_types' => 'forumnotification_types',
                'notifications' => 'forumnotifications',
                'poll_options' => 'forumpoll_options',
                'poll_votes' => 'forumpoll_votes',
                'posts' => 'forumposts',
                'privmsgs' => 'forumprivmsgs',
                'privmsgs_folder' => 'forumprivmsgs_folder',
                'privmsgs_rules' => 'forumprivmsgs_rules',
                'privmsgs_to' => 'forumprivmsgs_to',
                'profile_fields' => 'forumprofile_fields',
                'profile_fields_data' => 'forumprofile_fields_data',
                'profile_fields_options_language' => 'forumprofile_fields_lang',
                'profile_fields_language' => 'forumprofile_lang',
                'ranks' => 'forumranks',
                'reports' => 'forumreports',
                'reports_reasons' => 'forumreports_reasons',
                'search_results' => 'forumsearch_results',
                'search_wordlist' => 'forumsearch_wordlist',
                'search_wordmatch' => 'forumsearch_wordmatch',
                'sessions' => 'forumsessions',
                'sessions_keys' => 'forumsessions_keys',
                'sitelist' => 'forumsitelist',
                'smilies' => 'forumsmilies',
                'sphinx' => 'forumsphinx',
                'styles' => 'forumstyles',
                'styles_template' => 'forumstyles_template',
                'styles_template_data' => 'forumstyles_template_data',
                'styles_theme' => 'forumstyles_theme',
                'styles_imageset' => 'forumstyles_imageset',
                'styles_imageset_data' => 'forumstyles_imageset_data',
                'teampage' => 'forumteampage',
                'topics' => 'forumtopics',
                'topics_posted' => 'forumtopics_posted',
                'topics_track' => 'forumtopics_track',
                'topics_watch' => 'forumtopics_watch',
                'user_group' => 'forumuser_group',
                'user_notifications' => 'forumuser_notifications',
                'users' => 'forumusers',
                'warnings' => 'forumwarnings',
                'words' => 'forumwords',
                'zebra' => 'forumzebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'forum',
